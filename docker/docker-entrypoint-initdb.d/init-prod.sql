...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##MCM"."USER_PERFIL_SQ"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 0 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##MCM"."USER_PERFIL" 
   (	"ID_USER" NUMBER(*,0), 
	"ID_PERFIL" NUMBER(*,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
SET DEFINE OFF;
Insert into C##MCM.PERFIL (ID,NOME) values ('1','ADMIN');
Insert into C##MCM.PERFIL (ID,NOME) values ('2','CUSTUMER');
Insert into C##MCM.PERFIL (ID,NOME) values ('3','TECHNICIAN');
REM INSERTING into C##MCM.USER_PERFIL
SET DEFINE OFF;
Insert into C##MCM.USER_PERFIL (ID_USER,ID_PERFIL) values ('1','1');
Insert into C##MCM.USER_PERFIL (ID_USER,ID_PERFIL) values ('1','2');
Insert into C##MCM.USER_PERFIL (ID_USER,ID_PERFIL) values ('1','3');
Insert into C##MCM.USER_PERFIL (ID_USER,ID_PERFIL) values ('2','3');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##MCM"."USER_PERFIL_PK" ON "C##MCM"."USER_PERFIL" ("ID_USER", "ID_PERFIL") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##MCM"."USER_PERFIL" MODIFY ("ID_USER" NOT NULL ENABLE);
  ALTER TABLE "C##MCM"."USER_PERFIL" MODIFY ("ID_PERFIL" NOT NULL ENABLE);
  ALTER TABLE "C##MCM"."USER_PERFIL" ADD CONSTRAINT "USER_PERFIL_PK" PRIMARY KEY ("ID_USER", "ID_PERFIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##MCM"."PERFIL" MODIFY ("ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##MCM"."USER_PERFIL" ADD CONSTRAINT "USER_PERFIL_PERFIL_FK" FOREIGN KEY ("ID_PERFIL")
	  REFERENCES "C##MCM"."PERFIL" ("ID") ENABLE;
  ALTER TABLE "C##MCM"."USER_PERFIL" ADD CONSTRAINT "USER_PERFIL_USUARIO_FK" FOREIGN KEY ("ID_USER")

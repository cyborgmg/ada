...
==================
  ...
  * add ada support for `:`-delimited string
...
==================
  ...
  * Added `req.remoteUser` back to `ada()` as alias of `req.user`
...
==================
  ...
  * Changed `ada()` req.remoteUser to req.user
...
==================
  ...
  * Fixed ada realm issue when passing strings. Closes #253

1.2.2 / 2011-04-05
==================

  * Added `ada(username, password)` support
...
==================
  ...
  * Added ada async support. Closes #223
